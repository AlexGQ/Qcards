 ...
 */
public class DisplayCardsLayouts extends FragmentActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPagerAdapter = new ScreenSlidePagerAdapter(getSupportFragmentManager(),isLayout,-1,im.mThumbIds.length);
